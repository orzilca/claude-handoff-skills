...
This skill only **writes** the file. Resuming is separate: the user starts a fresh session ({{FRESH_SESSION}}), then runs {{CONTINUE_CMD}}. Never claim the context was cleared — only the user can do that.
